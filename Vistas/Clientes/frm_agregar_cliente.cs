...
namespace _02_CRUD.Vistas.Clientes
{
    public partial class frm_agregar_cliente : Form
    {
        ...
        {
            InitializeComponent();   // Aquí solo se llama, NO se define
        }
        ...
        public bool validacioncedula()
        {
            ...
            {
                MessageBox.Show("La cédula ingresada no contiene 10 caracteres");
                return false;
            }
            ...
            if (!validacion)
            {
                MessageBox.Show("El número de cédula ingresado es incorrecto");
                txt_Cedula.Text = "";
                txt_Cedula.Focus();
                return false;
            }
